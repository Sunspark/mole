...
public class RecordTypeControllerTest {
    ...
    @Test
    public void testGetRecordTypeById() throws Exception {
        this.mockMvc
                .perform(
                        get("/RecordTypes/1")
                ...
                .andExpect(jsonPath("$.content.recordTypeId").value(1))
                .andExpect(jsonPath("$._links.self.href").value("http://localhost/RecordTypes/1"))
