...
public class ReportTypeControllerTest {
    ...
    @Test
    public void testGetReportTypeById() throws Exception {
        this.mockMvc
                .perform(
                        get("/ReportTypes/1")
                ...
                .andExpect(jsonPath("$.content.reportTypeId").value(1))
                .andExpect(jsonPath("$._links.self.href").value("http://localhost/ReportTypes/1"))
